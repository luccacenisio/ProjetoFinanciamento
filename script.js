...
function financiamento () {
    ...
    if (renda !== '' && bem !== '' && entrada !== '' && juros !== '' && parcelas !== '') {
        ...
        resultado.textContent = `O valor das parcelas será de ${valor_mensal}.` 
        if (aprovacao < valor_mensal){
            resultado.textContent = `O valor das parcelas será de ${valor_mensal}, seu financiamento será recusado.`
        }else{
            resultado.textContent = `O valor das parcelas será de ${valor_mensal}, seu financiamento será aprovado.`
        }
    }else {
